...
Now that you have completed the MVP, I want you to think about the process it took you to get here. Is there anything you wish you had planned better? Anything you would do differently? Now take a minute think about how you would accomplish these same objectives with function components and hooks. You have experience with both formats now, so you can form opinions, but more importantly, you can back up those opinions. That's a really exciting level to be at! If you have time now, go ahead and move onto the stretch problems.
      ...
      I still prefer functions and hooks because they are much simpler and straightforward. I can see that classes allow me to have extra functionality. For example, componentWillUnmount allows me to delete things that belong to a component that is going to be unmounted. This allows me to prevent memory leaks. I was using functions and hooks, one of the things that I would have done differently is placing my axios call inside a useEffect hook with a dependency array as the second argument instead of placing it inside of a componentDidMount method. 
